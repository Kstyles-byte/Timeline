            ...
            >
              ...
              <div className="flex gap-4 justify-center">
                <motion.button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-red-500 to-rose-500 text-white rounded-full font-semibold hover:from-red-600 hover:to-rose-600 transition-all duration-300"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Log & Restart
