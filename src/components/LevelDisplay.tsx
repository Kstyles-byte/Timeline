    ...
    >
          ...
          >
            ...
            {isEditing ? (
              <input
                ...
                className="text-2xl font-bold text-teal-400 bg-transparent border-b-2 border-teal-300 focus:border-teal-400 focus:outline-none ml-2 placeholder-gray-400"
        ...
        <AnimatePresence mode="wait">
          {isEditing ? (
            <motion.textarea
              ...
              className="w-full p-3 border-2 border-slate-600 rounded-xl focus:border-teal-400 focus:outline-none resize-none bg-slate-700 text-gray-100 placeholder-gray-400"
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute text-center">
          <motion.span 
            className="text-3xl font-bold text-teal-300 block"
            key={daysCompleted}
            initial={{ scale: 0.5 }}
            animate={{ scale: 1 }}
          >
