            ...
            <motion.div
              ...
              className={cn(
                "aspect-square rounded-xl flex items-center justify-center font-bold text-lg border-2 transition-all duration-300 relative cursor-pointer",
                {
                  ...
                  "bg-indigo-600 text-white border-indigo-600 animate-pulse": isCurrent,
                  "bg-gray-50 text-gray-400 border-gray-200 hover:border-gray-300": !isCompleted && !isCurrent
                }
              )}
