          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                {
                  "bg-gradient-to-br from-green-600 to-emerald-700 text-white border-green-600 shadow-lg": isCompleted,
                  "bg-gradient-to-br from-emerald-500 to-green-600 text-white border-emerald-500 shadow-lg scale-105": isCurrent,
