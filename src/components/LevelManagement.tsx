    ...
    >
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-2xl font-semibold text-gray-100 flex items-center gap-3">
          <Trophy className="text-teal-300" size={24} />
          Level Management
        </h3>
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                {
                  "bg-gradient-to-br from-teal-600 to-cyan-700 text-white border-teal-600 shadow-lg": isCompleted,
                  "bg-gradient-to-br from-teal-500 to-cyan-600 text-white border-teal-500 shadow-lg scale-105": isCurrent,
